...
const closeFaucetCardModal = (event: any) => {
  event.preventDefault();
  mainScene.closeFaucetModal();
};

const closeGiftModal = (event: any) => {
  event.preventDefault();
  mainScene.closeGiftModal();
};

const openFaucet = (event: any) => {
  mainScene.openFaucet();
};

const openHangar = (event: any) => {
  event.preventDefault();
  mainScene.openHangar();
};

const closeCardModal = (event: any) => {
  event.preventDefault();
  mainScene.closeCardModal();
};

const burnCard = (event: any) => {
  event.preventDefault();
  mainScene.burnActiveCard();
};

const openWallet = (event: any) => {
  window.open(
